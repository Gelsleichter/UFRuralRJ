...
%% 
%% Neste formato, cada capítulo é preparado de maneira que possa ser lido individualmente, muitas vezes sendo 
%% baseado em trabalho publicado em revista científica na forma de artigo, revisão bibliográfica, ou nota 
%% científica. Assim sendo, cada capítulo possui aproximadamente a mesma estrutura de um desses tipos de 
%% comunicação científica, quais sejam: resumo, abstract, introdução, material e métodos, resultados, 
...
\include{capitulos-b/chapter00} %% Incluir Introdução Geral
\include{capitulos-b/chapter01} %% Incluir capítulo 01
\include{capitulos-b/chapter02} %% Incluir capítulo 02
\include{capitulos-b/chapter03} %% Incluir Conclusão Geral
