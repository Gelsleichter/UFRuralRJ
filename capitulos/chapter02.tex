...
\noindent{Este é o resumo do segundo artigo da tese. Reconheço que este artigo não é muito
diferente do anterior... Mas quem se importa?}
\end{chapterabstractPOR}

\begin{chapterabstractENG}{Key-word 1, Key-word 2, Key-word 3}
\noindent{This is the abstract of the second article of the thesis. I recognize that it is
