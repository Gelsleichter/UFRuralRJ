...
\usepackage{times}                    %% Usar fonte Adobe Times
...
\altCurso{Curso de Pós-Graduação em Agronomia}                 %% Curso de pós-graduação sem a área de concentração
\area{Ciência do Solo}                                         %% Área de concentração
\grau{Doutor em Ciências}                                    %% Grau obtido (geral)
\altGrau{Doutorado em Agronomia, Ciência do Solo}            %% Grau obtido (específico)
\altGrauENG{Doctor of Science in Agronomy, Soil Science}     %% Grau obtido (específico) em inglês
